...
```
## [1] "Cross-Validation Mean Absolute Value Error (Without 2020):  3.45844587320061"
```
...
```
## [1] "Cross-Validation Mean Absolute Value Error (Without 2020):  4.06313991208898"
```
...
```
## [1] "Cross-Validation Mean Absolute Value Error (Without 2020):  3.99951149985575"
```
...
```
## [1] "Cross-Validation Mean Absolute Value Error (Without 2020):  4.46973064505903"
```
...
```
## [1] "Cross-Validation Mean Absolute Value Error (Without 2020):  4.04931859929496"
```
